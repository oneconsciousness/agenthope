---
layout: skill
title: "Publish — one link you own"
skill_id: publish
tagline: "Put your portfolio on the web. Your agent carries the whole technical load — you just say yes once before it goes public."
plain_intro: "Your agent takes the portfolio it built and puts it online for free, on a page in your own name — one link you can drop into any application. It sets up everything that's missing, one gentle step at a time, and never asks you a scary technical question."
say: "publish my portfolio"
