...
title: About
permalink: /about/
description: JobHunt with Hope is a free, open-source pack of AI skills for laid-off workers, career switchers, and new grads. Built so your career data stays yours.
---
...
<div class="seg-grid">
  <div class="seg">
    <img class="seg-ico" src="{{ '/assets/img/seg-laid-off.png' | relative_url }}" alt="" width="52" height="52" loading="lazy" onerror="this.remove()" />
    <h3>Just laid off</h3>
    <p>Get a real presence back up <em>today</em> — not after three weeks of fighting a blank page. Your work didn't disappear; let's get it back in front of people.</p>
  </div>
  <div class="seg">
    <img class="seg-ico" src="{{ '/assets/img/seg-switching.png' | relative_url }}" alt="" width="52" height="52" loading="lazy" onerror="this.remove()" />
    <h3>Switching fields</h3>
    <p>Tell your story for the job you <em>want</em>, not the one you left. Hope reframes what you've done around where you're going.</p>
  </div>
  <div class="seg">
    <img class="seg-ico" src="{{ '/assets/img/seg-new-grad.png' | relative_url }}" alt="" width="52" height="52" loading="lazy" onerror="this.remove()" />
    <h3>First job, or fresh out of school</h3>
    <p>The class projects, the side work, the internships — shown like they count, before you've had the title.</p>
  </div>
</div>

And it's **not just for tech** — the [demo]({{ '/demo/' | relative_url }}) has a chef, a scientist, an advocate, a designer. AI is already screening you in your field too; you might as well use it back.
